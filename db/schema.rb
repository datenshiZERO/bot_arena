...
ActiveRecord::Schema.define(version: 20150420015518) do
  ...
  create_table "raids", force: :cascade do |t|
    ...
    t.integer  "quest_id"
    t.integer  "unit_1_id"
    t.boolean  "unit_1_front", default: true
    t.integer  "unit_2_id"
    t.boolean  "unit_2_front", default: true
    t.integer  "unit_3_id"
    t.boolean  "unit_3_front", default: true
    t.integer  "unit_4_id"
    t.boolean  "unit_4_front", default: true
    t.integer  "unit_5_id"
    t.boolean  "unit_5_front", default: true
    t.integer  "unit_6_id"
    t.boolean  "unit_6_front", default: true
